...
const popularProducts = [
  { id: 9, name: 'Apples', image: popularFruitsImage, rating: '★★★★☆', price: '₹60', stock: 100, manufacturedDate: '2024-09-01' },
  { id: 10, name: 'Broccoli', image: popularVegetablesImage, rating: '★★★★☆', price: '₹90', stock: 50, manufacturedDate: '2024-08-20' },
  { id: 11, name: 'Curd', image: popularDairyImage, rating: '★★★★☆', price: '₹35', stock: 200, manufacturedDate: '2024-09-10' },
  { id: 12, name: 'Jowar', image: popularMilletsImage, rating: '★★★★☆', price: '₹75', stock: 75, manufacturedDate: '2024-07-15' },
  { id: 13, name: 'Coffee', image: popularBeveragesImage, rating: '★★★★☆', price: '₹60', stock: 80, manufacturedDate: '2024-08-05' },
  { id: 14, name: 'Chocolate', image: popularSnacksImage, rating: '★★★★☆', price: '₹120', stock: 150, manufacturedDate: '2024-09-12' },
  { id: 15, name: 'Crab', image: popularMeatImage, rating: '★★★★☆', price: '₹700', stock: 25, manufacturedDate: '2024-09-15' },
  { id: 16, name: 'Cookies', image: popularBakeryImage, rating: '★★★★☆', price: '₹80', stock: 120, manufacturedDate: '2024-09-01' }
];
    ...
    <div className="grocery-page">
      ...
      <div className="content">
        <div className="banner">
          <h1 className='sample-header'>Discover Amazing Grocery Deals! <span>Shop Now</span></h1>
        </div>
